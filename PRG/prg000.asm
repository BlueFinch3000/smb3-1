...
Object_AttrFlags:
	...
	.byte OAT_BOUNDBOX13 | OAT_FIREIMMUNITY | OAT_WEAPONIMMUNITY	; Object $4B - OBJ_BOOMBOOMJUMP
	.byte OAT_BOUNDBOX13 | OAT_FIREIMMUNITY | OAT_WEAPONIMMUNITY	; Object $4C - OBJ_BOOMBOOMFLY
